      ...
      <div className="space-y-5">
        <div>
          ...
          <textarea
            ...
            className="w-full border-2 border-slate-200 focus:border-slate-800 rounded-xl p-4 outline-none transition-colors text-slate-900 resize-none"
            rows="6"
    ...
    >
      {loadingResults ? (
        ...
        <div className="space-y-6">
          ...
          {/* Party in Person CTA — shown only for Low risk */}
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-3">
            <div className="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden" data-testid="intelligence-panel">
              {renderProgressBar()}
